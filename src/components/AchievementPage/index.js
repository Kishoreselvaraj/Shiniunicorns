        ...
        <div className="slide-bar">
            <div className="achievement-section-slider-container">
                <Slider {...settings}>
                    ...
                    <div className="achievement-image-container">
                        <img src="/images/achievement5.jpeg" alt="achievement" className="achievement-image" />
                    </div>
                    <div className="achievement-image-container">
                        <img src="/images/achievement6.jpg" alt="achievement" className="achievement-image" />
                    </div>
                    <div className="achievement-image-container">
                        <img src="/images/achievement7.jpg" alt="achievement" className="achievement-image" />
                    </div>
                </Slider>
            </div>
        </div>
